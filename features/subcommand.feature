Feature: A command with subcommands
  ...
  Scenario: An subcommand is provided
    Given a command line named "my-command"
    When I add a subcommand "my-subcommand"
    And I call the command "my-command my-subcommand"
    Then it should succeed

  Scenario: An subcommand with options and parameters is provided
    Given a command line named "my-command"
    When I add a subcommand "my-subcommand"
    And I add a flag "a"
    ...
    And I call the command "my-command my-subcommand -a --foo baz abc def ghi jkl"
    Then it should succeed
  ...
  Scenario: An subcommand with options and parameters is provided with errors
    Given a command line named "my-command"
    When I add a subcommand "my-subcommand"
    And I add a flag "a"
    And I add an option "foo" with a parameter "bar"
    And I add a mandatory parameter "qux"
    And I add a variadic mandatory parameter "quux"
    And I call the command "my-command my-subcommand -b --foo"
    Then it should fail
